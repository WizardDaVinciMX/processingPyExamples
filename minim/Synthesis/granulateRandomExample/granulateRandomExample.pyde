...
class GrabularInstrument implements Instrument
{
  ...
  GrabularInstrument( amplitude, begFreq, endFreq )
 :
    # create instances of any UGen objects necessary
    # the tone
    Oscil toneOsc = Oscil( begFreq, amplitude, Waves.TRIANGLE)
    # a line to specify the frequency of the tone
    freqLine = Line( 2.6, begFreq, endFreq )
    # the granulation of the tone
    chopper = GranulateRandom( 0.005, 0.005, 0.001, 0.020, 0.020, 0.002 )
...
def setup()
{
  ...
  vol = 0.2
  noteLen = 4.5
  out.playNote( 0.0, noteLen, GrabularInstrument( vol, 440.0f, myTargetFreq ) )
  out.playNote( 0.1, noteLen, GrabularInstrument( vol, 440.0f, myTargetFreq ) )
  out.playNote( 0.2, noteLen, GrabularInstrument( vol, 440.0f, myTargetFreq ) )
  ...
  noteLen = 7.0
  nFreqs = 9
  myFreqs[] = float[ nFreqs ]
  for ( i=0 i<nFreqs i+=1 )
 :
    #myFreqs[ i ] = random( 900 ) + 100.0
    myFreqs[ i ] = i*220.0
  
  out.playNote( 0.00, noteLen, GrabularInstrument( vol, myTargetFreq, myFreqs[ 0 ] ) )
  out.playNote( 0.05, noteLen, GrabularInstrument( vol, myTargetFreq, myFreqs[ 1 ] ) )
  out.playNote( 0.10, noteLen, GrabularInstrument( vol, myTargetFreq, myFreqs[ 2 ] ) )
  out.playNote( 0.15, noteLen, GrabularInstrument( vol, myTargetFreq, myFreqs[ 3 ] ) )
  out.playNote( 0.20, noteLen, GrabularInstrument( vol, myTargetFreq, myFreqs[ 4 ] ) )
  out.playNote( 0.25, noteLen, GrabularInstrument( vol, myTargetFreq, myFreqs[ 5 ] ) )
  out.playNote( 0.30, noteLen, GrabularInstrument( vol, myTargetFreq, myFreqs[ 6 ] ) )
  out.playNote( 0.35, noteLen, GrabularInstrument( vol, myTargetFreq, myFreqs[ 7 ] ) )
  out.playNote( 0.40, noteLen, GrabularInstrument( vol, myTargetFreq, myFreqs[ 8 ] ) )
  ...
  vol = 0.15
  noteLen = 7.0
  out.playNote( 0.05, noteLen, GrabularInstrument( vol, myFreqs[ 0 ], myTargetFreq ) )
  out.playNote( 0.10, noteLen, GrabularInstrument( vol, myFreqs[ 1 ], myTargetFreq ) )
  out.playNote( 0.15, noteLen, GrabularInstrument( vol, myFreqs[ 2 ], myTargetFreq ) )
  out.playNote( 0.20, noteLen, GrabularInstrument( vol, myFreqs[ 3 ], myTargetFreq ) )
  out.playNote( 0.25, noteLen, GrabularInstrument( vol, myFreqs[ 4 ], myTargetFreq ) )
  out.playNote( 0.30, noteLen, GrabularInstrument( vol, myFreqs[ 5 ], myTargetFreq ) )
  out.playNote( 0.35, noteLen, GrabularInstrument( vol, myFreqs[ 6 ], myTargetFreq ) )
  out.playNote( 0.40, noteLen, GrabularInstrument( vol, myFreqs[ 7 ], myTargetFreq ) )
  out.playNote( 0.45, noteLen, GrabularInstrument( vol, myFreqs[ 8 ], myTargetFreq ) )
