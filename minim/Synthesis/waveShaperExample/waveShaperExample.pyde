...
def setup()
{
  ...
  ChikInstrument chik = ChikInstrument( out )
  chikDur = 0.1f
 ...
 :
    ...
    out.playNote( 0.f, 1.0f, WaveShaperInstrument( Frequency.ofPitch("C2").asHz(), shaperAmp, out ) )
    out.playNote( 1.f, chikDur, chik )
    out.playNote( 2.f, chikDur, chik )
    out.playNote( 3.f, chikDur, chik )
    
    out.playNote( 4.f, 1.0f, WaveShaperInstrument( Frequency.ofPitch("C2").asHz(), shaperAmp, out ) )
    out.playNote( 4.f, chikDur, chik )
    out.playNote( 5.f, chikDur, chik )
    out.playNote( 5.5f, 1.0f, WaveShaperInstrument( Frequency.ofPitch("Eb2").asHz(), shaperAmp, out ) )
    out.playNote( 6.f, chikDur, chik )
    out.playNote( 7.f, chikDur, chik )
    out.playNote( 7.f, 1.0f, WaveShaperInstrument( Frequency.ofPitch("Eb2").asHz(), shaperAmp, out ) )
  
  # one last hit!
  out.playNote( 8.f, chikDur, chik )
  out.playNote( 8.f, 8.0f, WaveShaperInstrument( Frequency.ofPitch("C1").asHz(), shaperAmp, out ) )
...
class WaveShaperInstrument implements Instrument
{
  ...
  WaveShaperInstrument(frequency, amplitude, AudioOutput output)
 :
    out = output
    ...
    Wavetable shapeA = Wavetable( Waves.SAW )
    shapeA.set(0, -1.0)
    ...
    shaper = WaveShaper(amplitude, 5, shapeA)
    
    # If we want to shape the sine with a saw wave... 
    #shaper = WaveShaper( amplitude, 5, Waves.SAW )
    ...
    #shaper = WaveShaper( amplitude, 5, Waves.SAW, true )
    
    shaperAmountLine = Line(5.f, 1.f, 25.f)
    reciprocal = Reciprocal()
