...
class ToneInstrument implements Instrument
{
  ...
  ToneInstrument(frequency, amplitude, lfoFrequency, lfoAmplitude)
 :
    sineOsc = Oscil(frequency, amplitude, Waves.SINE)
    lFOOsc = Oscil(lfoFrequency, lfoAmplitude, Waves.SINE)
...
def setup()
{
  ...
  myNote = ToneInstrument( 200.f, 0.3, 0.5f, 1.0f )
  ...
  myNote = ToneInstrument( 415.3f, 0.3, 1.f, 1.f )
  out.playNote(2.f, 0.5f, myNote )
  
  myNote = ToneInstrument( 415.3f, 0.3, 2.f, 1.f )
  out.playNote(3.5, 0.5f, myNote )
  
  myNote = ToneInstrument( 415.3f, 0.3, 3.f, 1.f )
  out.playNote(5.f, 0.5f, myNote )
  
  myNote = ToneInstrument( 830.6f, 0.3, 5.f, 1.f )
