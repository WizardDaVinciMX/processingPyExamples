...
def setup()
{
  ...
  # is very different
  out.playNote(0.25, 5.5, SlideInstrument(110, 880, 0.8 ) )
  out.playNote(0.25, 5.5, MidiSlideInstrument(45.0, 81.0, 0.8 ))
  
  # replay the slide faster and alternating between the two types.
  out.playNote( 6.00, 0.2, SlideInstrument( 110, 880, 0.8 ) )
  out.playNote( 6.25, 0.2, MidiSlideInstrument( 45.0, 81.0, 0.8 ) )
  out.playNote( 6.50, 0.2, SlideInstrument( 110, 880, 0.8 ) )
  out.playNote( 6.75, 0.2, MidiSlideInstrument( 45.0, 81.0, 0.8 ) )
  out.playNote( 7.00, 0.2, SlideInstrument( 110, 880, 0.8 ) )
  out.playNote( 7.25, 0.2, MidiSlideInstrument( 45.0, 81.0, 0.8 ) )
  out.playNote( 7.50, 0.2, SlideInstrument( 110, 880, 0.8 ) )
  out.playNote( 7.75, 0.2, MidiSlideInstrument( 45.0, 81.0, 0.8 ) )
