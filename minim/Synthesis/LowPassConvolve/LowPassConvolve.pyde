...
def setup()
{
  ...
  float[] kernel = float[]: 0, 0.005, 0.01, 0.018, 0.021, 0.03, 0.034, 0.037, 0.04, 0.042, 0.044, 0.046, 0.048, 0.049, 0.05,
                                 0.049, 0.048, 0.046, 0.044, 0.042, 0.04, 0.037, 0.034, 0.03, 0.021, 0.018, 0.01, 0.005, 0 
  # make a Convolver, passing the kernal array and the buffer size 
  # of the signal that will be convolved with the kernal                              
  lpf = Convolver(kernel, groove.bufferSize())
