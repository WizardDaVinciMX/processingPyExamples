...
{  
  ...
  myFollow = FollowInstrument( 0.5, 87.3, 1.0, 0.150, out ) 
  ...
  out.playNote( 1.0, 1.4, LeaderInstrument( lVol, 174.61, myFollow, out ) )  
  out.playNote( 2.5, 0.4, LeaderInstrument( lVol, 233.08, myFollow, out ) )  
  out.playNote( 3.0, 1.4, LeaderInstrument( lVol, 311.13, myFollow, out ) )
  out.playNote( 4.5, 0.4, LeaderInstrument( lVol, 293.66, myFollow, out ) )  
  out.playNote( 5.0, 0.4, LeaderInstrument( lVol, 233.08, myFollow, out ) )
  out.playNote( 5.5, 0.4, LeaderInstrument( lVol, 196.00, myFollow, out ) )
  out.playNote( 6.0, 0.4, LeaderInstrument( lVol, 261.63, myFollow, out ) )
  out.playNote( 6.5, 3.0, LeaderInstrument( lVol, 349.23, myFollow, out ) )
...
def draw()
{
  ...
  myBG = map ( myFollow.getCurrentFrequency(), 150, 500, 0, 255 )
