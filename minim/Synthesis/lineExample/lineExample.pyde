...
class MidiSlideInstrument implements Instrument
{
  ...
  MidiSlideInstrument(begNote, endNote, amp )
 : 
    # create instances of any UGen objects as necessary
    tone = Oscil( begNote, amp, Waves.SQUARE )
    adsrGate = ADSR( 1.0, 0.001, 0.0, 1.0, 0.001 )
    freqControl = Line( 1.0, begNote, endNote )
    midi2Hz = Midi2Hz()
...
{ 
  ...
  # short pop
  out.playNote( 0.0, 0.1, MidiSlideInstrument( 48, 48, 0.2 ) )

  # long slide up of one note
  out.playNote( 1.0, 2.00, MidiSlideInstrument( 48, 60, 0.2 ) )
  
  # a few blips and chirps
  out.playNote( 1.0, 0.1, MidiSlideInstrument( 87, 99, 0.2 ) )
  out.playNote( 1.5, 0.05, MidiSlideInstrument( 99, 99, 0.2 ) )
  out.playNote( 3.0, 0.1, MidiSlideInstrument( 87, 99, 0.2 ) )  
  out.playNote( 4.0, 0.1, MidiSlideInstrument( 48, 48, 0.2 ) )
  out.playNote( 4.25, 0.1, MidiSlideInstrument( 48, 48, 0.2 ) )
  
  # slide of a chord up 
  out.playNote( 5.0, 2.00, MidiSlideInstrument( 48, 60, 0.2 ) )
  out.playNote( 5.0, 2.00, MidiSlideInstrument( 60, 72, 0.2 ) )
  out.playNote( 5.0, 2.00, MidiSlideInstrument( 67, 79, 0.2 ) )
  
  # two more blips
  out.playNote( 8.0, 0.1, MidiSlideInstrument( 84, 84, 0.2 ) )
  out.playNote( 8.25, 0.05, MidiSlideInstrument( 96, 84, 0.2 ) )

  # a 1 beat chord slide down
  out.playNote( 9.0, 1.00, MidiSlideInstrument( 60, 55, 0.2 ) )
  out.playNote( 9.0, 1.00, MidiSlideInstrument( 72, 67, 0.2 ) )
  out.playNote( 9.0, 1.00, MidiSlideInstrument( 79, 74, 0.2 ) )
  
  # after a quarter beat pause, continue that chord down
  out.playNote( 10.25, 0.75, MidiSlideInstrument( 55, 48, 0.2 ) )
  out.playNote( 10.25, 0.75, MidiSlideInstrument( 67, 60, 0.2 ) )
  out.playNote( 10.25, 0.75, MidiSlideInstrument( 74, 67, 0.2 ) )
  
  # more chirps
  out.playNote( 11.5, 0.05, MidiSlideInstrument( 84, 96, 0.2 ) )
  out.playNote( 11.125, 0.05, MidiSlideInstrument( 60, 48, 0.2 ) )
  out.playNote( 11.25, 0.05, MidiSlideInstrument( 96, 48, 0.2 ) )

  # one long slow note down
  out.playNote( 12.00, 2.5, MidiSlideInstrument( 60, 48, 0.2 ) )
  
  # joined by two others (this does not make a harmonic chord,
  # because the notes are all sliding to one common goal)
  out.playNote( 13.00, 1.5, MidiSlideInstrument( 55, 48, 0.2 ) )
  out.playNote( 13.00, 1.5, MidiSlideInstrument( 67, 48, 0.2 ) )
  
  # two constant notes with a sliding note
  out.playNote( 15.00, 2.0, MidiSlideInstrument( 48, 48, 0.2 ) )  
  out.playNote( 15.00, 1.0, MidiSlideInstrument( 36, 48, 0.2 ) )
  out.playNote( 15.00, 1.01, MidiSlideInstrument( 36, 36, 0.1 ) )
  
  # more chirps
  out.playNote( 16.5, 0.05, MidiSlideInstrument( 48, 36, 0.2 ) )
  out.playNote( 16.75, 0.05, MidiSlideInstrument( 70, 48, 0.2 ) )
  
  # and final blips and chirps
  out.playNote( 17.50, 0.1, MidiSlideInstrument( 96, 96, 0.2 ) )
  out.playNote( 18.00, 0.1, MidiSlideInstrument( 72, 84, 0.1 ) )
  out.playNote( 18.00, 0.2, MidiSlideInstrument( 84, 84, 0.2 ) )
