...
class SteadyGrainInstrument implements Instrument
{
  ...
  SteadyGrainInstrument( frequency, amplitude, period, percentOn )
 : 
    # create instances of any UGen objects as necessary
    # Need the triangle tone to chop up.
    Oscil toneOsc = Oscil( frequency, amplitude, Waves.TRIANGLE )
    # need the GranulateSteady envelope
    chopper = GranulateSteady( period*percentOn, period*( 1 - percentOn ), 0.0025 )
...
def setup()
{
  ...
  out.playNote( 0.000, 16.0, SteadyGrainInstrument( 110f, 0.5, 1.0, 0.05 ) )
  out.playNote( 0.125, 16.0, SteadyGrainInstrument( 110f, 0.5, 1.0, 0.05 ) )
 
  # The "snare" hits come in
  out.playNote( 4.500, 11.500, SteadyGrainInstrument( 1320f, 0.3, 1.0, 0.03 ) )
  out.playNote( 4.625, 11.325, SteadyGrainInstrument( 1320f, 0.3, 1.0, 0.03 ) )
  
  # Start doubling up the bass and snare in the 4th measure
  out.playNote( 7.250, 8.750, SteadyGrainInstrument( 110f, 0.5, 4.0, 0.0125 ) )
  out.playNote( 7.375, 8.625, SteadyGrainInstrument( 110f, 0.5, 4.0, 0.0125 ) )
  out.playNote( 7.750, 8.250, SteadyGrainInstrument( 1320f, 0.3, 4.0, 0.0125 ) )
  out.playNote( 7.875, 8.125, SteadyGrainInstrument( 1320f, 0.3, 4.0, 0.0125 ) )

  # At the beginning of the 8th measure add in a me-me-me-me  
  out.playNote( 8.00, 8.00, SteadyGrainInstrument( 4840f, 0.1, 0.125, 0.50 ) )
  # And eventually put in a syncopated we-we-we-we which lasts past the section end
  out.playNote( 12.0625, 8.00, SteadyGrainInstrument( 7260f, 0.06, 0.125, 0.75 ) )

  # start a section --------------------------------------------------------------
  out.setNoteOffset( 16.0 )
 
  # Keep the bass hits going
  out.playNote( 0.000, 8.50, SteadyGrainInstrument( 110f, 0.5, 2.0, 0.03 ) )
  out.playNote( 0.125, 8.50, SteadyGrainInstrument( 110f, 0.5, 2.0, 0.03 ) )
  ...
  # back at audio rate.
  out.playNote( 0.00, 4.00, SteadyGrainInstrument( 9680f, 0.1, 0.042, 0.20 ) )
  out.playNote( 0.50, 4.00, SteadyGrainInstrument( 7260f, 0.1, 0.031, 0.50 ) )
  out.playNote( 1.00, 4.00, SteadyGrainInstrument( 4840f, 0.1, 0.031, 0.50 ) )
  out.playNote( 2.00, 4.00, SteadyGrainInstrument( 2420f, 0.1, 0.020, 0.50 ) )
  out.playNote( 2.50, 4.00, SteadyGrainInstrument( 1815f, 0.1, 0.010, 0.50 ) )
  out.playNote( 3.00, 4.00, SteadyGrainInstrument( 1210f, 0.1, 0.010, 0.50 ) )
  out.playNote( 4.00, 4.00, SteadyGrainInstrument( 550f, 0.1, 0.012, 0.50 ) )
  out.playNote( 5.002, 3.00, SteadyGrainInstrument( 775f, 0.1, 0.012, 0.750 ) )
  out.playNote( 6.008, 2.00, SteadyGrainInstrument( 775f, 0.2, 0.012, 0.750 ) )
  out.playNote( 7.00, 1.00, SteadyGrainInstrument( 775f, 0.1, 0.012, 0.750 ) )
