...
# just plays a burst of noise of the specified tand amplitude
...
def setup()
{
  ...
  myWhiteNoise = NoiseInstrument( 0.5, Noise.Tint.WHITE )
  myPinkNoise = NoiseInstrument( 0.5, Noise.Tint.PINK )
  myRedNoise = NoiseInstrument( 0.5, Noise.Tint.RED )
