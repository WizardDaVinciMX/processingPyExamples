"""*
  ...
  * meaning that if it was already playing it will continue playing from the position, but if it was not playing, 
  * skipping will not start playback, it will simply set the poat which playback will begin. 
