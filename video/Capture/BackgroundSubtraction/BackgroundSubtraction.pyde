...
def draw():
  if video.available():
    ...
    presenceSum = 0
    for i in range(0, numPixels): # For each pixel in the video frame...
    ...
    println(presenceSum) # Prout the total amount of movement
