...
ControlP5 cp5
public myColor = color(0, 0, 0)

public sliderValue = 100
public sliderTicks1 = 100
public sliderTicks2 = 30
...
controlP5.ControllerProperties : def setFormat(PropertiesStorageFormat) 
controlP5.ControllerProperties : def setFormat(String) 
