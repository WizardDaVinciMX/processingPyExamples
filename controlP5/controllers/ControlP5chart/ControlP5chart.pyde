...
def setup() :
  ...
  myChart.setData("incoming", float[100])
...
controlP5.Chart : getStrokeWeight() 
controlP5.Chart : float[] getValuesFrom(String) 
controlP5.Chart : getResolution() 
controlP5.Chart : size() 
controlP5.Chart : def onEnter() 
controlP5.Chart : def onLeave() 
