...
def setup() :
  ...
  myTextlabelB = Textlabel(cp5,"Another textlabel, not created through ControlP5 needs to be rendered separately by calling Textlabel.draw(PApplet).",100,100,400,200)
...
controlP5.Textlabel : getLineHeight() 
controlP5.Textlabel : def draw() 
controlP5.Textlabel : def draw(PApplet) 
controlP5.Textlabel : def draw(PGraphics) 
controlP5.Textlabel : def draw(int, int) 
