...
def setup() :
  ...
  b.onMove(CallbackListener():
    public def controlEvent(CallbackEvent ev) :
...
controlP5.ButtonBar : hover() 
controlP5.ButtonBar : def changeItem(String, String, Object) 
controlP5.ButtonBar : def onClick() 
