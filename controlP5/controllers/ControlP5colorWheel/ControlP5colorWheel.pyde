...
controlP5.ColorWheel : HSLtoRGB(double, double, double) 
controlP5.ColorWheel : HSLtoRGB(double[]) 
controlP5.ColorWheel : HSVtoRGB(double, double, double) 
controlP5.ColorWheel : HSVtoRGB(double[]) 
controlP5.ColorWheel : a() 
controlP5.ColorWheel : b() 
controlP5.ColorWheel : g() 
controlP5.ColorWheel : getRGB() 
controlP5.ColorWheel : r() 
controlP5.ColorWheel : def onDrag() 
controlP5.ColorWheel : def onEndDrag() 
controlP5.ColorWheel : def onPress() 
controlP5.ColorWheel : def onRelease() 
controlP5.ColorWheel : def onStartDrag() 
controlP5.ColorWheel : def setHue(double) 
controlP5.ColorWheel : def setLightness(double) 
controlP5.ColorWheel : def setSaturation(double) 
