...
public def bang() :
  theColor = (int)random(255)
  myColorBackground = color(theColor)
  println("0x0x0x bang(). a bang event. setting background to "+theColor)
...
public def controlEvent(ControlEvent theEvent) :
  ...
  println(
  "0x0x controlEvent / id:"+theEvent.controller().getId()+
...
controlP5.Bang : getTriggerEvent() 
