...
controlP5.Slider : getMax() 
controlP5.Slider : getMin() 
controlP5.Slider : getValue() 
controlP5.Slider : getValuePosition() 
controlP5.Slider : getDirection() 
controlP5.Slider : getHandleSize() 
controlP5.Slider : getNumberOfTickMarks() 
controlP5.Slider : getSliderMode() 
controlP5.Slider : getTriggerEvent() 
