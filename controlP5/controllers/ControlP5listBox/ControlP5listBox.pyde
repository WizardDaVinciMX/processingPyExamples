...
def setup() :
  ...
  for (i=0i<80i+=1) :
    l.addItem("item "+i, i)
    l.getItem("item "+i).put("color", CColor().setBackground(0xffff0000).setBackground(0xffff8800))
...
def controlEvent(ControlEvent theEvent) :
  ...
  # if (theEvent.isGroup())
  # to adef an error message from controlP5.
  ...
  if(theEvent.isGroup() and theEvent.getName().equals("myList")):
    test = (int)theEvent.getGroup().getValue()
    println("test "+test)
...
controlP5.Controller : getArrayValue(int) 
controlP5.Controller : getDefaultValue() 
controlP5.Controller : getMax() 
controlP5.Controller : getMin() 
controlP5.Controller : getValue() 
controlP5.Controller : float[] getAbsolutePosition() 
controlP5.Controller : float[] getArrayValue() 
controlP5.Controller : float[] getPosition() 
controlP5.Controller : getDecimalPrecision() 
controlP5.Controller : getHeight() 
controlP5.Controller : getId() 
controlP5.Controller : getWidth() 
controlP5.Controller : listenerSize() 
controlP5.Controller : def remove() 
controlP5.Controller : def setView(ControllerView, int) 
...
controlP5.ListBox : getBackgroundColor() 
controlP5.ListBox : getBarHeight() 
controlP5.ListBox : getHeight() 
controlP5.ListBox : def controlEvent(ControlEvent) 
controlP5.ListBox : def keyEvent(KeyEvent) 
controlP5.ListBox : def setDirection(int) 
controlP5.ListBox : def updateItemIndexOffset() 
