...
def draw() :
  ...
  for(i=1i<400i+=1) :
    y0 = cos(map(i-1,0,s.getArrayValue()[0],-PI,PI)) * s.getArrayValue()[1] 
    y1 = cos(map(i,0,s.getArrayValue()[0],-PI,PI)) * s.getArrayValue()[1]
    line((i-1),y0,i,y1)
...
controlP5.Slider2D : getCursorHeight() 
controlP5.Slider2D : getCursorWidth() 
controlP5.Slider2D : getCursorX() 
controlP5.Slider2D : getCursorY() 
controlP5.Slider2D : getMaxX() 
controlP5.Slider2D : getMaxY() 
controlP5.Slider2D : getMinX() 
controlP5.Slider2D : getMinY() 
controlP5.Slider2D : float[] getArrayValue() 
controlP5.Slider2D : def setValueLabelSeparator(String) 
