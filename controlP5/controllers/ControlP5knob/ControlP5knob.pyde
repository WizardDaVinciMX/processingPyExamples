...
controlP5.Knob : getAngle() 
controlP5.Knob : getAngleRange() 
controlP5.Knob : getRadius() 
controlP5.Knob : getResolution() 
controlP5.Knob : getStartAngle() 
controlP5.Knob : getTickMarkWeight() 
controlP5.Knob : getValue() 
controlP5.Knob : getDragDirection() 
controlP5.Knob : getNumberOfTickMarks() 
controlP5.Knob : getTickMarkLength() 
controlP5.Knob : getViewStyle() 
