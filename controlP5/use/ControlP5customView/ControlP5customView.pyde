...
public def hello(theValue) :
  println("Hello pressed")


public def world(theValue) :
...
class CircularButton implements ControllerView<Button> :
  ...
  public def display(PGraphics theApplet, Button theButton) :
    ...
    x = theButton.getWidth()/2 - theButton.getCaptionLabel().getWidth()/2
    y = theButton.getHeight()/2 - theButton.getCaptionLabel().getHeight()/2
...
controlP5.ControllerView : def display(PApplet, T)
