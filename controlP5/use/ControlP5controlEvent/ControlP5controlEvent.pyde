...
public myColorRect1 = 200

public myColorRect2 = 100
...
controlP5.ControlEvent : getArrayValue(int) 
controlP5.ControlEvent : getValue() 
controlP5.ControlEvent : float[] getArrayValue() 
controlP5.ControlEvent : getId() 
controlP5.ControlEvent : getType() 
