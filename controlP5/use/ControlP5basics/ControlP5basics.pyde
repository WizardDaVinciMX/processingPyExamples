...
ControlP5 cp5
public myColorRect = 200
public myColorBackground = 100
...
public def numberboxC(theValue) :
  println("0x0x0x got an event from numberboxC : "+theValue)



# an event from slider sliderA will change the value of textfield textA here
public def sliderA(theValue) :
...
public def textA(String theValue) :
  println("0x0x0x got an event from textA : "+theValue)
