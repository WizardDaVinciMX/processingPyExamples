...
def setup() :
  ...
  List<String> drops = ArrayList<String>()
  for(i=0i<100i+=1) :
    drops.add("item "+i)
...
def controlEvent(ControlEvent event) :
  println(event)
...
def addMouseWheelListener() :
  frame.addMouseWheelListener(java.awt.event.MouseWheelListener() :
    public def mouseWheelMoved(java.awt.event.MouseWheelEvent e) :
